...
//LEVEL 1
    ...
    Level0.placeRoom(0,1,"right");
    Level0.placeRoom(0,2,"right");
    Level0.placeRoom(0,3,"right");
    Level0.placeRoom(6,3,"right");
    Level0.placeRoom(5,4,"down");
    Level0.placeRoom(0,0,"down");
    Level0.placeRoom(0,1,"down");
    Level0.placeRoom(0,2,"down");
    Level0.placeRoom(0,3,"down");
    ...
    Level0.setDestination(0,6,4);
    Level0.setDestination(0,6,3);
    Level0.setDestination(0,6,2);
    Level0.setDestination(0,6,1);
    Level0.setDestination(0,6,0);
    Level0.setDestination(0,5,0);
    Level0.setDestination(0,4,0);
    Level0.setDestination(0,3,0);
    Level0.setDestination(0,2,0);
    Level0.setDestination(0,1,0);
    Level0.setDestination(0,0,0);
    Level0.setDestination(0,0,1);
    Level0.setDestination(0,0,2);
    Level0.setDestination(0,0,3);

    Level0.placeSafe(6,4);
