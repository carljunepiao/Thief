...
###################################
PROJECT REQUIREMENT in CMSC 141
-----------------------------------
INTRUCTIONS:
	
	Apply finite automata. The project is to create a maze game in 2D where finite automata is applied in the movement of the character and the maaze itself. 
